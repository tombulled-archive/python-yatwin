...
"""
Library containing upgrade_firmware (an instance of <ParamMethod>)
...
ENDPOINT = 'upgrade_firmware.cgi'
DESCRIPTION = \
(
    'upgrade device firmware. Note: this cgi compress files '
...
upgrade_firmware = method_types.ParamMethod \
(
    endpoint = ENDPOINT,
